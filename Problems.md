jq中$.post在360浏览器中的问题，select中获取选中的option的元素和自定义属性的值，textarea随着文本增加自适应高度,svg和canvas,本地缓存(页面跳转后显示弹窗),http://www.jq22.com/jquery-info18940,访问样式表(不能修改样式表，可以增加样式表)，浮动不换行 
